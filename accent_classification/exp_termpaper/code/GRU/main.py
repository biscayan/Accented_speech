...
def main(num_epochs, learning_rate, batch_size):
    ...
    ### model
    gru_model=GRU_model(13,150,5,1).to(device)
    print(gru_model)
    ...
    ### experiment
    Train(gru_model, train_loader, val_loader, optimizer, criterion, device, num_epochs)
    Test(gru_model, test_loader, device)
