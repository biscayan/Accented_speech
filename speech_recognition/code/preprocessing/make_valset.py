...
###data path
aus_path='/home/skgudwn34/Accented_speech/speech_recognition/dataset/val_dataset/Australia/'
can_path='/home/skgudwn34/Accented_speech/speech_recognition/dataset/val_dataset/Canada/'
eng_path='/home/skgudwn34/Accented_speech/speech_recognition/dataset/val_dataset/England/'
ind_path='/home/skgudwn34/Accented_speech/speech_recognition/dataset/val_dataset/India/'
us_path='/home/skgudwn34/Accented_speech/speech_recognition/dataset/val_dataset/US/'
...
aus_val_df=make_dataset(aus_path,aus_csv)
can_val_df=make_dataset(can_path,can_csv)
eng_val_df=make_dataset(eng_path,eng_csv)
ind_val_df=make_dataset(ind_path,ind_csv)
us_val_df=make_dataset(us_path,us_csv)

val_df=pd.concat([aus_val_df,can_val_df,eng_val_df,ind_val_df,us_val_df])

###data save
val_df.to_pickle(save_path+'val_set') 
#val_df.to_csv(save_path+'val_set.csv',index=False) 