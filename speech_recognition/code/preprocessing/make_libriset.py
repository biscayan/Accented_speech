...
if __name__=='__main__':
    ...
    ###csv path
    train_csv=open('/home/skgudwn34/Accented_speech/speech_recognition/csv/libri_train360.csv','r',encoding='UTF8')
    ...
    ###data path
    train_path='/home/skgudwn34/Accented_speech/speech_recognition/libri_dataset/train_dataset360/'
    ...
    ###data save
    train_df.to_pickle(save_path+'libri_train360')
